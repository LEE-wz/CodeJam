...
- [ ] **P14-01** Add the plan artifact. Extend `CoordinationTurnKind` with `"session_plan"` and `ArtifactType` with `"session_plan"`, and define the payload:
